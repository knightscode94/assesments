...
def three(arg1):
    ...
    # Given a string seperate the string into the individual numbers present, then add each digit of each number 
	# to get a final value for each number
...
def four(arg1):
	list1=arg1.split()
	listint=map(int, list1)
	intlist=list(listint)
